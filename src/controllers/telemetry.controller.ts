...
const create = asyncHandler(async (req: Request, res: Response) => {
  const reading = await TelemetryReading.create({
    ...
    leftInsideC: req.body.leftInsideC,
    rightInsideC: req.body.rightInsideC,
    leftMiddleC: req.body.leftMiddleC,
    rightMiddleC: req.body.rightMiddleC,
    leftNearDoorC: req.body.leftNearDoorC,
    rightNearDoorC: req.body.rightNearDoorC,
